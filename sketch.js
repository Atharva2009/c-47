...
if(Pac.isTouching(Sp)){

//for(i=0;i<SP.length;i++){
//if(SP.get(i).isTouching(Sp)){
//   SP.get(i).remove()
//}
//}
...
function draw(){
 ...
 if(gameState===PLAY){
   ...
   if(keyDown("DOWN_ARROW")){
    Pac.velocityY=4
    PacD.addAnimation("Rundown",pacD);
    PacD.scale=0.005
}
...
switch(r){
    case 1: gh1.velocityX=-10;
    break;
    case 2: gh1.velocityX=10;
    break;
    case 3: gh1.velocityY=10;
    break;
    case 4: gh1.velocityY=10;
    break;
    default: break;
